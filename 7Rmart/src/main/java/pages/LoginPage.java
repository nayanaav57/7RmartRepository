...
public class LoginPage {
	...
	// @FindBy(xpath="//input[@type='text']")private WebElement
	// usernameField;//syntax
	...
	public HomePage submitClick() {
		...
		// WaitUtility wait = new WaitUtility();//applying wait using method created in
		// wait utility class
		// wait.waitForElementToBeClickable(driver, signbutton);
		signbutton.click();
		return new HomePage(driver);
		// PageUtility page =new PageUtility();// program execution using method created
		// in page utility class
		// page.javaSriptClick(driver, signbutton);// passing driver and webelement name
		// given for clicking button
