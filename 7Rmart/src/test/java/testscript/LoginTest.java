...
public class LoginTest extends Base {
	...
	public void verifyTheUserIsAbleToLoginUsingValidCredentials()throws Exception {    //String username,//String password) 
		...
		Assert.assertTrue(ishomepageloaded,"unable to login using valid credentials");
	}
	...
	public void verifyTheUserUnableToLoginUsingInvalidUserName(String username, String password) throws Exception {
		...
		Assert.assertTrue(isalertmessageshown,"failed to execute:verifyTheUserUnableToLoginUsingInvalidUserName");
	}
	...
	public void verifyTheUserUnableToLoginUsingInvalidPassword() throws Exception {
		...
		loginpage.submitClick();
		boolean isalertmessageshown=loginpage.isAlertMessageDisplayed();
		Assert.assertTrue(isalertmessageshown,"failed to execute:verifyTheUserUnableToLoginUsingInvalidPassword");
	...
	public void verifyTheUserUnableToLoginUsingInvalidUsernameAndPassword() throws Exception {
		...
		loginpage.submitClick();
		boolean isalertmessageshown=loginpage.isAlertMessageDisplayed();
		Assert.assertTrue(isalertmessageshown,"verifyTheUserUnableToLoginUsingInvalidUsernameAndPassword");
	}
}
